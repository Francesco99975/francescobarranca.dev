<template>
  <main
    class="flex flex-col justify-center items-center w-full p-2 text-primary text-center"
  >
    <h1 class="font-bold italic text-2xl text-accent">
      Privacy Policy for francescobarranca.dev
    </h1>

    <p>
      At francescobarranca.dev, accessible from francescobarranca.dev, one of
      ...
      francescobarranca.dev and how we use it.
    </p>
    ...
    <p>
      ...
      and/or collect in francescobarranca.dev. This policy is not applicable to
    ...
    <ul class="flex w-full md:w-2/3 flex-col justify-center items-center py-2">
    ...
    <p>
      francescobarranca.dev follows a standard procedure of using log files.
    ...
    <p>
      ...
      advertising partners of francescobarranca.dev.
    </p>

    <p>
      Third-party ad servers or ad networks uses technologies like cookies,
      JavaScript, or Web Beacons that are used in their respective
      advertisements and links that appear on francescobarranca.dev, which are
    ...
    <p>
      Note that francescobarranca.dev has no access to or control over these
    ...
    <p>
      francescobarranca.dev's Privacy Policy does not apply to other advertisers
    ...
    <p>
      francescobarranca.dev does not knowingly collect any Personal Identifiable
