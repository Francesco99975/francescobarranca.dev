<template>
  <main
    class="flex flex-col w-full justify-center items-center text-center text-primary"
  >
    <h2><strong>Terms and Conditions</strong></h2>

    <p>Welcome to francescobarranca.dev!</p>

    <p>
      These terms and conditions outline the rules and regulations for the use
      of francescobarranca.dev's Website, located at francescobarranca.dev.
    </p>

    <p>
      By accessing this website we assume you accept these terms and conditions.
      Do not continue to use francescobarranca.dev if you do not agree to take
    ...
    <p>
      We employ the use of cookies. By accessing francescobarranca.dev, you
      agreed to use cookies in agreement with the francescobarranca.dev's
      Privacy Policy.
    </p>
    ...
    <p>
      Unless otherwise stated, francescobarranca.dev and/or its licensors own
      the intellectual property rights for all material on
      francescobarranca.dev. All intellectual property rights are reserved. You
      may access this from francescobarranca.dev for your own personal use
      subjected to restrictions set in these terms and conditions.
    </p>

    <p>You must not:</p>
    <ul>
      <li>Republish material from francescobarranca.dev</li>
      <li>Sell, rent or sub-license material from francescobarranca.dev</li>
      <li>Reproduce, duplicate or copy material from francescobarranca.dev</li>
      <li>Redistribute content from francescobarranca.dev</li>
    </ul>
    ...
    <p>
      ...
      francescobarranca.dev does not filter, edit, publish or review Comments
      prior to their presence on the website. Comments do not reflect the views
      and opinions of francescobarranca.dev,its agents and/or affiliates.
      ...
      francescobarranca.dev shall not be liable for the Comments or for any
    ...
    <p>
      francescobarranca.dev reserves the right to monitor all Comments and to
    ...
    <p>
      You hereby grant francescobarranca.dev a non-exclusive license to use,
    ...
    <p>
      ...
      hyperlink compensates the absence of francescobarranca.dev; and (d) the
    ...
    <p>
      ...
      e-mail to francescobarranca.dev. Please include your name, your
    ...
    <p>
      No use of francescobarranca.dev's logo or other artwork will be allowed
...
<style scoped>
h2 {
  @apply font-bold text-accent italic text-xl;
}

h3 {
  @apply text-accent italic text-lg;
}

p {
  @apply w-full md:w-2/3 leading-6 my-2;
}

li {
  @apply py-2 italic underline underline-offset-4;
}

ul {
  @apply flex flex-col w-full md:w-2/3 justify-center items-center py-2;
}

li {
  @apply py-2 underline underline-offset-4 italic;
}
</style>
